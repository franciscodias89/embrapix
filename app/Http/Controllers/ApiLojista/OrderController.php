...
// ALTERADO - inclui id, city, complement, etc..
...

    {
        ...
        if ($user) {
            ...
            if($type=='new'){
                $orders_running = Order::where('restaurant_id', $user->restaurant_id)->where('orderstatus_id', '1')->with('orderitems', 'orderitems.order_item_addons', 'restaurant')->orderBy('id', 'DESC')->get();
                $orders_finished = Order::where('restaurant_id', $user->restaurant_id)->whereIn('orderstatus_id', ['5','6','10'])->with('orderitems', 'orderitems.order_item_addons', 'restaurant')->orderBy('id', 'DESC')->get();
            ...
            if($type=='running'){
                $orders_running = Order::where('restaurant_id', $user->restaurant_id)->whereIn('orderstatus_id', ['2','3','4','7','8','9'])->with('orderitems', 'orderitems.order_item_addons', 'restaurant')->orderBy('id', 'DESC')->get();
                $orders_finished = Order::where('restaurant_id', $user->restaurant_id)->whereIn('orderstatus_id', ['5','6','10'])->with('orderitems', 'orderitems.order_item_addons', 'restaurant')->orderBy('id', 'DESC')->get();
           ...
           if ($type=='finished'){
            $orders_finished = Order::where('restaurant_id', $user->restaurant_id)->whereIn('orderstatus_id', ['5','6','10'])->with('orderitems', 'orderitems.order_item_addons', 'restaurant')->orderBy('id', 'DESC')->get();
            $orders_running = Order::where('restaurant_id', $user->restaurant_id)->whereIn('orderstatus_id', ['1','2','3','4','7','8','9'])->with('orderitems', 'orderitems.order_item_addons', 'restaurant')->orderBy('id', 'DESC')->get();
