...
@section('content')
    <div class="contents">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl col-lg-4 col-md-6 .col-sm-12 mb-25">
                    <!-- Profile Acoount -->
                    <div class="card">
                            ...
                            <div class="account-profile-cards  ">
                                <div class="ap-img d-flex justify-content-center">
                                    ...
                                    <img class="ap-img__main bg-opacity-primary  wh-120 rounded-circle mb-3 "
                                         src="{{ asset('img/tm1.png') }}" alt="profile">
                                </div>
                                ...
                                <div
                                    ...
                                    <button type="button"
                                        ...
                                        <span data-feather="mail"></span>message
                                    </button>
                                    <button type="button"
                                            class="border text-capitalize px-25 color-gray transparent shadow2 follow radius-md">
                                        <span class="las la-user-plus follow-icon"></span>follow
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="card-body text-center pt-30 px-25 pb-0">
                            <div class="account-profile-cards  ">
                                <div class="ap-img d-flex justify-content-center">
                                    <!-- Profile picture image-->
                                    <img class="ap-img__main bg-opacity-primary  wh-120 rounded-circle mb-3 "
                                         src="{{ asset('img/tm2.png') }}" alt="profile">
                                </div>
                                <div class="ap-nameAddress">
                                    <h6 class="ap-nameAddress__title">Duran Clayton</h6>
                                    <p class="ap-nameAddress__subTitle  fs-14 pt-1 m-0 ">UI/UX Designer</p>
                        ...
                        <div class="card-body text-center pt-30 px-25 pb-0">
                            <div class="account-profile-cards  ">
                                <div class="ap-img d-flex justify-content-center">
                                    <!-- Profile picture image-->
                                    <img class="ap-img__main bg-opacity-primary  wh-120 rounded-circle mb-3 "
                                         src="{{ asset('img/tm3.png') }}" alt="profile">
                                </div>
                                <div class="ap-nameAddress">
                                    <h6 class="ap-nameAddress__title">Duran Clayton</h6>
                                    <p class="ap-nameAddress__subTitle  fs-14 pt-1 m-0 ">UI/UX Designer</p>
                        ...
                        <div class="card-body text-center pt-30 px-25 pb-0">
                            <div class="account-profile-cards  ">
                                <div class="ap-img d-flex justify-content-center">
                                    <!-- Profile picture image-->
                                    <img class="ap-img__main bg-opacity-primary  wh-120 rounded-circle mb-3 "
                                         src="{{ asset('img/tm4.png') }}" alt="profile">
                                </div>
                                <div class="ap-nameAddress">
                                    <h6 class="ap-nameAddress__title">Duran Clayton</h6>
                                    <p class="ap-nameAddress__subTitle  fs-14 pt-1 m-0 ">UI/UX Designer</p>
                        ...
                        <div class="card-body text-center pt-30 px-25 pb-0">
                            <div class="account-profile-cards  ">
                                <div class="ap-img d-flex justify-content-center">
                                    <!-- Profile picture image-->
                                    <img class="ap-img__main bg-opacity-primary  wh-120 rounded-circle mb-3 "
                                         src="{{ asset('img/tm5.png') }}" alt="profile">
                                </div>
                                <div class="ap-nameAddress">
                                    <h6 class="ap-nameAddress__title">Duran Clayton</h6>
                                    <p class="ap-nameAddress__subTitle  fs-14 pt-1 m-0 ">UI/UX Designer</p>
                        ...
                        <div class="card-body text-center pt-30 px-25 pb-0">
                            <div class="account-profile-cards  ">
                                <div class="ap-img d-flex justify-content-center">
                                    <!-- Profile picture image-->
                                    <img class="ap-img__main bg-opacity-primary  wh-120 rounded-circle mb-3 "
                                         src="{{ asset('img/tm6.png') }}" alt="profile">
                                </div>
                                <div class="ap-nameAddress">
                                    <h6 class="ap-nameAddress__title">Duran Clayton</h6>
                                    <p class="ap-nameAddress__subTitle  fs-14 pt-1 m-0 ">UI/UX Designer</p>
