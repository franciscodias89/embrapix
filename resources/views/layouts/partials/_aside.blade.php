...
<aside class="sidebar">
    <div class="sidebar__menu-group">
       <ul class="sidebar_nav">
         ...
         <li>
            <a class="{{ Route::is('restaurant.orders') ? 'active' : ''}}"
               href="{{ route('restaurant.orders') }}">
               <span data-feather="shopping-cart" class="nav-icon"></span>
               <span class="menu-text">Vendas</span>
               {{-- <span class="badge badge-success menuItem">5</span> --}}
            </a>
         </li>
         <li>
            <a class="{{ Route::is('panel.customers') ? 'active' : ''}}"
               href="{{ route('panel.customers') }}">
        ...
        {{--  <li>
            ...
            <span class="menu-text">Vendas Realizadas</span>
            </a>
         </li> --}}
...
<aside class="sidebar">
    <div class="sidebar__menu-group">
       <ul class="sidebar_nav">
          ...
          <li>
            <a class="{{ Route::is('admin.stores') ? 'active' : ''}}"
         ...
         <li>
            <a class="{{ Route::is('admin.sellers') ? 'active' : ''}}"
         ...
         <li>
           {{--  <a class="{{ Route::is('restaurant.get.editRestaurant') ? 'active' : ''}}"
               href="{{ route('restaurant.get.editRestaurant') }}">
               <span data-feather="settings" class="nav-icon"></span>
               <span class="menu-text">Configurações</span>wizard.wizard_1
               
            </a> --}}
           {{--  <a class="{{ Route::is('panel.settingsProfile') ? 'active' : ''}}"
 ...
 <aside class="sidebar">
     <div class="sidebar__menu-group">
        <ul class="sidebar_nav">
           ...
           {{-- <li>
             <a class="{{ Route::is('restaurant.dashboard') ? 'active' : ''}}"
          ...
          <li>
             <a class="{{ Route::is('licencer.restaurants') ? 'active' : ''}}"
                href="{{ route('licencer.restaurants') }}">
                <span data-feather="shopping-cart" class="nav-icon"></span>
                <span class="menu-text">Lojas</span>
                {{-- <span class="badge badge-success menuItem">5</span> --}}
             </a>
