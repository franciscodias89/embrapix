            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Vendedores</h4>
                    ...
                    <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                             ...
                             <div class="project-category d-flex align-items-center  mt-xl-10 mt-15">
                                ...
                                <div class="project-tap order-project-tap global-shadow">
                                    <ul class="nav px-1" id="ap-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('admin.sellers') ? 'active' : ''}}" href="{{ route('admin.sellers') }}">Todos</a>
                                        </li>
                                       {{--  <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('admin.sellersDeleted') ? 'active' : ''}}" href="{{ route('admin.sellersDeleted') }}">Lixeira</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="content-center mt-10">
                            <div class="button-group m-0 mt-xl-0 mt-sm-10 order-button-group">
                                ...
                                <i class="la la-plus"></i>Adicionar Vendedor</button>
                                    ...
                                    <thead>
                                        <tr class="userDatatable-header">
                                          ...
                                          {{--   <th><span class="userDatatable-title">Logo</span></th> --}}
                                            <th><span class="userDatatable-title">Nome do Vendedor</span></th>
                                            <th><span class="userDatatable-title">Loja</span></th>
                                        ...
                                        <tr class="item">
                                           ...
                                           {{--  <td><img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}{{ $restaurant->image }}"
                                            ...
                                            <td style="white-space:normal;">
                                                <div class="orderDatatable-title">{{ $seller->name }}
                                                </div>
                                            </td>
                                            <td style="white-space:normal;">
                                                <div class="orderDatatable-title">{{ $seller->restaurant->name }}
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <ul class="orderDatatable_actions mb-0 d-flex flex-wrap float-right">
                                                    ...
                                                    @if(Request::is('store-owner/sellers/deleted'))
                                                    <li>
                                                        <a href="{{ route('admin.restoreSeller', $seller->id) }}" title="Restaurar" class="edit">
                                                            <span data-feather="rotate-ccw" ></span></a>
                                                    </li>
                                                    @else
                                                    <li>
                                                        <a href="{{ route('admin.get.editSeller', $seller->id) }}" title="Editar" class="edit">
                                                            <span data-feather="edit"></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.deleteSeller', $seller->id) }}" title="Excluir" onclick="return confirm('Tem certeza de que deseja excluir este item?')" class="remove">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Adicionar Vendedor</span></h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form action="{{ route('admin.saveNewSeller') }}" method="POST" enctype="multipart/form-data" data-parsley-trigger="keyup" data-parsley-validate>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">
                                            <i class="" aria-hidden="true"></i> <h5>Dados do Vendedor</h5>
                                        </div>
                                    ...
                                    <div class="card-body pl30 pr30">
                                        <div class="form-group row" style="margin-left: 15px;"> 
                                            <div class="custom-control custom-switch switch-primary switch-md ">
                                                ...
                                                <label id="produto_ativo" class="custom-control-label" for="is_active" style="color:#0cb946"> Vendedor Habilitado</label>
                                                <label id="produto_desativado" class="custom-control-label hidden" for="is_active" style="color:#e22f0f"> Vendedor Desabilitado</label>
                                             </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="js-example-placeholder-single js-states" name="store_id" id="store_id" required>
                                                    @foreach ($stores as $store)
                                                    <option value="{{ $store->id }}" class="text-capitalize">
                                                        {{ $store->name }}</option>
                                                    @endforeach
                                                </select>
