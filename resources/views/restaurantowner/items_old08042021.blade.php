                                        ...
                                        <tr class="item">
                                            ...
                                            <td>
                                                <div class="orderDatatable-title">
                                                    ...
                                                    @else
                                                    <span >R$ {{ str_replace(".",",",$item->price)  }}</span>
                                                    @endif
                                            ...
                                            <td class="text-center">
                                                <div class="" style="display: inline-block; vertical-align: top;">
                                                    <a href="{{ route('restaurant.get.editItem', $item->id) }}" class="btn btn-primary">Editar</a>
                                                </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('restaurant.saveNewItem') }}" method="POST" enctype="multipart/form-data" data-parsley-trigger="keyup" data-parsley-validate>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pl15 pr15">
                                        ...
                                        <div class="form-group col-md-6"
                                            ...
                                            <label for="ean"><span class="text-danger">*</span>Código de Barras (EAN)</label>
                                        ...
                                        <div class="form-group">
                                            <label class="">Grupo de Adicionais (opcional):</label>
                                ...
                                <div class="users">
                                    <div class="card">
                                        ...
                                        <div class="card-body pl15 pr15">
                                            <div class="form-group row" style="margin-left: 15px;"> 
                                                <div class="custom-control custom-switch switch-primary switch-md ">
                                                    <input type="checkbox" name="is_offer" class="custom-control-input" id="is_offer" >
                                                    <label class="custom-control-label" for="is_offer"> Oferta</label>
                                                 </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div  class="col-lg-6" style="display: none;" id="discountedTwoPrice">
                                                        
                                                            <label><span class="text-danger">*</span>Preço Normal (R$): <i class="icon-question3 ml-1"
                                                    ...
                                                    <div class="col-lg-6">
                                                    <div  style="display: none;" id="precodesconto">
                                                        <label><span class="text-danger">*</span>Preço (com Desconto) (R$):</label>
                                                    </div>
                                                    <div  id="preco">
                                                        <label><span class="text-danger">*</span>Preço Oferta (R$):</label>
                                                    </div>
                                                        <input type="text" class="form-control dinheiro" name="price"
                                                            placeholder="Preço (R$)" id="newSP"
                                                            data-parsley-required-message="Este campo é obrigatório" 
