                                        ...
                                        <div class="card-body pl15 pr15">
                                            ...
                                            <div class="form-group col-md-6"
                                                ...
                                                <input required type="text" class="form-control ean" name="ean"
                                                    ...
                                                    placeholder="Código de Barras (EAN)" value="{{ $item->ean }}"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body pl15 pr15">
                                                <div class="form-group row" style="margin-left: 15px;"> 
                                                    <div class="custom-control custom-switch switch-primary switch-md ">
                                                        @if ($item->is_offer==1)
                                                        <input type="checkbox" name="is_offer" class="custom-control-input" id="is_offer" checked>
                                                        @else
                                                    ...
                                                    <div class="form-group row">
                                                        <div  class="col-lg-6" style="display: none;" id="discountedTwoPrice">
                                                                ...
                                                                <label><span class="text-danger">*</span>Preço (sem desconto) (R$): <i class="icon-question3 ml-1"
