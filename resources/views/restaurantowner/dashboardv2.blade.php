@extends('layouts.vertical',['isDarkSidebar' => true],['isCondensedSidebar' => true])
@section("title")
...
<div class="content">
    <div class="d-flex justify-content-end mt-2">
        <a href="{{ route('restaurant.zenMode', "false") }}"><i data-feather="power" style="font-size: 1.7rem; color: #eee" data-popup="tooltip" data-placement="right" title="Quit ZenMode"></i><i class="icon-switch" style="font-size: 1.3rem; color: #eee" data-popup="tooltip" data-placement="right" title="Quit ZenMode"></i></a>
    </div>
    ...
    <div class="col @if($agent->isMobile()) d-inline-block @endif">
        <div class="card">
            <div class="text-center">
                <h4 style="color:rgb(230, 227, 227)" class="mt-2 mb-0"><strong>{{__('storeDashboard.dashboardNewOrders')}} <span class="badge badge-flat dark-badge ml-1" id="newOrdersCount">
                    {{ count($newOrders) }}
                    </span></strong>
                </h4>
                <hr class="mt-1 mb-0">
            ...
            <div class="card-body px-2" style="height: 95vh; overflow-y: scroll;">
                ...
                <div class="text-center pt-2 pb-1 single-order-parent" id="newOrdersNoOrdersMessage">
                    <h4 style="color:white"> {{__('storeDashboard.dashboardNoOrders')}} </h4>
                </div>
                @endif
    ...
    <div class="col @if($agent->isMobile()) d-inline-block @endif">
        <div class="card">
            <div class="text-center">
                <h4 style="color:rgb(230, 227, 227)" class="mt-2 mb-0"><strong>{{__('storeDashboard.dashboardPreparingOrders')}} <span class="badge badge-flat dark-badge ml-1">
    ...
    <div class="col @if($agent->isMobile()) d-inline-block @endif">
        <div class="card">
            <div class="text-center">
                <h4 style="color:rgb(230, 227, 227)" class="mt-2 mb-0"><strong>{{__('storeDashboard.dashboardSelfpickupOrders')}} <span class="badge badge-flat dark-badge ml-1">
    ...
    <div class="col @if($agent->isMobile()) d-inline-block @endif">
        <div class="card">
            <div class="text-center">
                <h4 style="color:rgb(230, 227, 227)" class="mt-2 mb-0"><strong>{{__('storeDashboard.dashboardOngoingDeliveries')}} <span class="badge badge-flat dark-badge ml-1">
                    {{ count($ongoingOrders) }}
                    </span></strong>
                </h4>
                <hr class="mt-1 mb-0">
...
<div id="viewOrderModal" class="modal fade mt-1" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="height: 95vh;border-radius: 0.8rem;">
...
@section('script')  
        ...
        <!-- /core JS files -->
        <script type="text/javascript" src="https://app.comprabakana.com.br/assets/backend/js/jquery.overlayScrollbars.min.js"></script>
<script>
    ...
    $(".card-body").overlayScrollbars({
        ...
        function updateClock() {
            ...
            $('.liveTimer').each(function(index, el) {
                ...
                formattedTime += checkMin ? " " +m+ " minuto" : "";
                }
                if(s > 1){
                    formattedTime += checkSec ? " " +s+ " segundos" : "";
                }else{
                    formattedTime += checkSec ? " " +s+ " segundo" : "";
                }
