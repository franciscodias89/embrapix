                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumb-main">
                            <h4 class="breadcrumb-title">Editando o Grupo de Opções:  {{ $addonCategory->name }}</h4>
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('panel.updateAddonCategory') }}" 
                        id="editaddon" 
                        method="POST" 
                                            ...
                                            <div class="card-body pl30 pr30">
                                                <div class="form-group row" style="margin-left: 15px;"> 
                                                    <div class="custom-control custom-switch switch-primary switch-md ">
                                                        <input type="checkbox" name="status" class="custom-control-input" id="status" @if($addonCategory->status==1) checked @endif>
                                                        <label id="produto_ativo" class="custom-control-label" for="status" style="color:#0cb946"> Grupo de Opções Ativo</label>
                                                        <label id="produto_desativado" class="custom-control-label hidden" for="status" style="color:#e22f0f"> Grupo de Opções Desativado</label>
                                                     </div>
                                                    </div>
                                                ...
                                                <div class="form-group row" >
                                                    ...
                                                    <input required type="text" class="form-control name" name="name"
                                                        ...
                                                        data-parsley-trigger="keyup"  value="{{ $addonCategory->name }}" data-parsley-group="form-step-1" 
                                    ...
                                    <div class="col-md-6" style="padding-left: 0px; float: left;"> 
                                        <div class="card">
                                            ...
                                            <div class="card-body pl15 pr15">
                                                ...
                                                <div class="row col-md-12 hidden" id='minmax'>
                                                    <div class="form-group col-md-6" style="padding-left: 0px;">
                                                        <label for="min_subtotal"><span class="text-danger"></span>Escolher no Mínimo:</label>
                                                            ...
                                                            max="{{ $countaddons -1 }}"
                                                            placeholder="" 
                                                            data-parsley-lt2="#maxoption"
                                                            value={{ $addonCategory->min }} 
                                                            data-parsley-lt2-message="Esse campo deve ser menor ou igual ao valor máximo" 
                                                            id="minoption"
                                                            >
                                                    ...
                                                    <div class="form-group col-md-6" style="padding-right: 0px;">
                                                        <label for="max_count">
                                                            ...
                                                            placeholder=""  
                                                            id="maxoption"
                                                            value={{ $addonCategory->max }} 
                                                            data-parsley-gt2="#minoption"
                                                            data-parsley-gt2-message="Esse campo deve ser maior ou igual ao valor mínimo" 
                                                            >
                                                    </div>
                                                </div>
                            ...
                            {{-- <div class="d-flex align-items-center flex-wrap justify-content-center"> --}}
                                ...
                                <div class="content-center mt-10">
                                    <div class="button-group m-0 mb-30 mt-xl-0 mt-sm-10 order-button-group">
                                        ...
                                        title="Editar" 
                                        class="btn btn-primary createAddonCategory" 
                                        data-toggle="modal" 
                                        data-target="#addNewItemCategory" 
                                        data-catid="{{ $addonCategory->id }}"  >
                                        <span data-feather="plus"></span>Adicionar Opção</a>
                                        ...
                                        <tbody>
                                            ...
                                            @if($addon->is_deleted==0)
                                                ...
                                                <tr class="item">
                                                    ...
                                                    <td style="white-space:normal;">
                                                        <div class="orderDatatable-title">R$ {{ str_replace('.',',',$addon->price) }}
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap float-right">
                                                            ...
                                                            <li>
                                                                <a href="{{ route('panel.deleteAddon', $addon->id) }}" title="Excluir" onclick="return confirm('Tem certeza de que deseja excluir este item?')" class="remove">
            ...
            <div class="modal-body">
                <form action="{{ route('panel.createAddon') }}" method="POST">
                    <div class="form-group row">
                        ...
                        <input type="text"  name="addon_category_id"
                        hidden id="itemCataddonCategoryid">
                            <input 
                            type="text" 
...
$(function () {
  $('#editaddon').parsley().refresh();
  
  $("#maxoption").on('keyup', function() {
        $("input[name=min]").parsley().reset();
        
    });
    $("#minoption").on('keyup', function() {
        $("input[name=max]").parsley().reset();
...
var is_active= "<?php  echo $addonCategory->status; ?>";  
            if (is_active== 1) {
                $("#produto_ativo").show();
        ...
        var countaddons= "<?php  echo $countaddons; ?>"; 
        ...
        if (($(this).val()  == "MULTI") && countaddons>1) {
...
var type= "<?php  echo $addonCategory->type; ?>";  
if (type==='SINGLE') {
    $('#minmax').addClass('hidden');
   
}
if ((type=== "MULTI" ) && countaddons>1) {
    $('#minmax').removeClass('hidden');
...
window.Parsley.addValidator('gt2', {
  ...
  priority: 32
    ...
    $(function() {
            ...
            $('.createAddonCategory').click(function(event) {
                $('#itemCataddonCategoryid').val($(this).data("catid"));
            });
