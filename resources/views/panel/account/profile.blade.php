              ...
              <div class="row justify-content-center">
                  <div class="col-xl-8 col-lg-10 col-sm-10">
                      <div class="edit-profile__body mx-lg-20">
                          <form action="{{ route('account.saveProfile') }}" method="POST" id="profile_form" enctype="multipart/form-data">
                            @csrf
                            <input hidden type="text" value="{{ $user->id }}" class="form-control" name="id">
                            ...
                            <div class="form-group mb-20">
                                <label for="contact_manager_whatsapp">Telefone</label>
                                
                          
                                
                                  <input required type="text" value="{{ $user->phone }}" class="form-control phone" name="contact_manager_whatsapp"
