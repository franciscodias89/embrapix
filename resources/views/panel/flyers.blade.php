            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Folhetos</h4>
                    ...
                    <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                            ...
                            <div class="project-category d-flex align-items-center ml-md-30 mt-xl-10 mt-15">
                                ...
                                <div class="project-tap order-project-tap global-shadow">
                                    <ul class="nav px-1" id="ap-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('panel.flyers') ? 'active' : ''}}" href="{{ route('panel.flyers') }}">Todos</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('panel.flyersNonExpired') ? 'active' : ''}}" href="{{ route('panel.flyersNonExpired') }}">Ativos</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('panel.flyersExpired') ? 'active' : ''}}" href="{{ route('panel.flyersExpired') }}" >Vencidos
                                                </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('panel.flyersDeleted') ? 'active' : ''}}" href="{{ route('panel.flyersDeleted') }}">Lixeira</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="content-center mt-10">
                            <div class="button-group m-0 mt-xl-0 mt-sm-10 order-button-group">
                                ...
                                <i class="la la-plus"></i>Adicionar Folheto</button>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 table-hover table-borderless border-0" id="itemsDataTable">
                                    ...
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title">Data Início</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">Data Fim</span>
                                        </th>
                                        <th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="item">
                                            ...
                                            <td>
                                                <div class="orderDatatable-title">
                                                <span >{{ date( 'd/m/Y' , strtotime($flyer->start_date)) }}</span> 
                                                </div>
                                            </td>
                                            <td>
                                                <div class="orderDatatable-title">
                                                    <span >{{ date( 'd/m/Y' , strtotime($flyer->end_date)) }}</span> 
                                                    </div>
                                                    </td>
                                            <td>
                                                ...
                                                <div class="orderDatatable-status d-inline-block">
                                                    <span class="order-bg-opacity-danger  text-danger rounded-pill active">Vencido</span>
                                                </div>
                                                @endif
                                                @if(date('Y-m-d' ,strtotime($flyer->start_date)) > date('Y-m-d' ,strtotime($agora)) && date('Y-m-d' ,strtotime($flyer->end_date)) > date('Y-m-d' ,strtotime($agora)) )
                                                ...
                                                <div class="orderDatatable-status d-inline-block">
                                                    <span class="order-bg-opacity-primary  text-primary rounded-pill active">Futuro</span>
                                                </div>
                                                @endif 
                                            </td>
                                            <td><div class="orderDatatable-title float-right">
                                                {{ $flyer->created_at->diffForHumans() }}
                                            </div>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <ul class="orderDatatable_actions mb-0 d-flex flex-wrap float-right">
                                                    ...
                                                    @if(Request::is('store-owner/flyers/deleted'))
                                                    <li>
                                                        <a href="{{ route('panel.restoreFlyer', $flyer->id) }}" title="Restaurar" class="edit">
                                                            <span data-feather="rotate-ccw" ></span></a>
                                                    </li>
                                                    @else
                                                    <li>
                                                        <a href="{{ route('panel.get.editFlyer', $flyer->id) }}" title="Editar" class="edit">
                                                            <span data-feather="edit"></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('panel.deleteFlyer', $flyer->id) }}" title="Excluir" onclick="return confirm('Tem certeza de que deseja excluir este item?')" class="remove">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Adicionar Folheto</span></h5>
