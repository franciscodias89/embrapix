      ...
      <div class="card">
          <div class="card-header  px-sm-25 px-3">
              ...
              <div class="button-group d-flex flex-wrap pt-30 mb-15">
                <button type="submit" form="selfpickupcalendar_form" class="btn btn-primary btn-default btn-squared mr-15 text-capitalize">Salvar 
                </button>
                        ...
                        <div class="atbd-nav-controller">
                            <div class="btn-group atbd-button-group btn-group-normal nav" role="tablist">
                              ...
                              @if(($restaurant->delivery_type == 1 )|| ($restaurant->delivery_type == 3))
                               <a href="{{ route('panel.DeliveryCalendar') }}" class="btn btn-sm btn-outline-light nav-link " id="size-default"  aria-controls="default" aria-selected="false"> Horários de Delivery</a>
                               @endif
                                <a href="{{ route('panel.SelfpickupCalendar') }}" class="btn btn-sm btn-outline-light nav-link active" id="size-small"  aria-controls="small" aria-selected="true">Horários para Retirada</a>
                                
                                
                            </div>
                         </div>
                        <form 
                                       action="{{ route('settings.saveSelfpickupCalendar') }}" 
                                       method="POST" 
                                       enctype="multipart/form-data" 
                                       data-parsley-trigger="keyup" 
                                       id="selfpickupcalendar_form"
                            ...
                            @if(!empty($working_time->_monday) && count($working_time->_monday) > 0)
                            <!-- If yes Then Loop Each Data as Time SLots -->
                            @foreach($working_time->_monday as $time)
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2" day="_monday">
                            ...
                            @endforeach
                            @endif
                            <div id="_monday" class="timeSlots">
                            </div>
                            <a href="javascript:void(0)" onclick="add(this)" data-day="_monday" class="btn btn-primary  mr-2"> <b><i class="icon-plus22"></i></b>Adicionar Horário</a>
                            <hr>
                            ...
                            <!-- Checks if there is any schedule data -->
                            @if(!empty($working_time->_tuesday) && count($working_time->_tuesday) > 0)
                            <!-- If yes Then Loop Each Data as Time SLots -->
                            @foreach($working_time->_tuesday as $time)
                            <div class="form-group row">
                                <div class="col-lg-5">
                                    <label class="col-form-label">{{ __('storeDashboard.seOpeningTime') }}</label>
                                    <input type="text" class="form-control clock " value="{{$time->open}}"
                                        name="_tuesday[]" required>
                                </div>
                                <div class="col-lg-5">
                                    <label class="col-form-label"></span>{{ __('storeDashboard.seClosingTime') }}</label>
                                    <input type="text" class="form-control clock " value="{{$time->close}}"
                                ...
                                <div class="col-lg-2" day="_tuesday">
                                    <label class="col-form-label text-center" style="width: 70px;"></span>Remover</label><br>
                                    <button class='remove btn btn-danger btn-default btn-squared mr-15' style='padding: 10px;' data-popup='tooltip' data-placement='right' title='Remover Horário'><i class='la la-trash-alt'></i>
                                    </button>
                                </div>
                            ...
                            @endforeach
                            @endif
                            <div id="_tuesday" class="timeSlots">
                            </div>
                            <a href="javascript:void(0)" onclick="add(this)" data-day="_tuesday" class="btn btn-primary mr-2"> <b><i class="icon-plus22"></i></b>Adicionar Horário</a>
                            <hr>
                            <div class="form-group row mb-0">
                                <div class="col-lg-12">
                                    <h4>Quarta-Feira</h4>
                            ...
                            <!-- Checks if there is any schedule data -->
                            @if(!empty($working_time->_wednesday) && count($working_time->_wednesday) > 0)
                            <!-- If yes Then Loop Each Data as Time SLots -->
                            @foreach($working_time->_wednesday as $time)
                            <div class="form-group row">
                                <div class="col-lg-5">
                                    <label class="col-form-label">{{ __('storeDashboard.seOpeningTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->open}}"
                                        name="_wednesday[]" required>
                                </div>
                                <div class="col-lg-5">
                                    <label class="col-form-label"></span>{{ __('storeDashboard.seClosingTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->close}}"
                                ...
                                <div class="col-lg-2" day="_wednesday">
                                    <label class="col-form-label text-center" style="width: 70px;"></span>Remover</label><br>
                                    <button class='remove btn btn-danger btn-default btn-squared mr-15' style='padding: 10px;' data-popup='tooltip' data-placement='right' title='Remover Horário'><i class='la la-trash-alt'></i>
                                    </button>
                                </div>
                            ...
                            @endforeach
                            @endif
                            <div id="_wednesday" class="timeSlots">
                            </div>
                            <a href="javascript:void(0)" onclick="add(this)" data-day="_wednesday" class="btn btn-primary  mr-2"> <b><i class="icon-plus22"></i></b>Adicionar Horário</a>
                            <hr>
                            <div class="form-group row mb-0">
                                <div class="col-lg-12">
                                    <h4>Quinta-Feira</h4>
                            ...
                            <!-- Checks if there is any schedule data -->
                            @if(!empty($working_time->_thursday) && count($working_time->_thursday) > 0)
                            <!-- If yes Then Loop Each Data as Time SLots -->
                            @foreach($working_time->_thursday as $time)
                            <div class="form-group row">
                                <div class="col-lg-5">
                                    <label class="col-form-label">{{ __('storeDashboard.seOpeningTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->open}}"
                                        name="_thursday[]" required>
                                </div>
                                <div class="col-lg-5">
                                    <label class="col-form-label"></span>{{ __('storeDashboard.seClosingTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->close}}"
                                ...
                                <div class="col-lg-2" day="_thursday">
                                    <label class="col-form-label text-center" style="width: 70px;"></span>Remover</label><br>
                                    <button class='remove btn btn-danger btn-default btn-squared mr-15' style='padding: 10px;' data-popup='tooltip' data-placement='right' title='Remover Horário'><i class='la la-trash-alt'></i>
                                    </button>
                                </div>
                            ...
                            @endforeach
                            @endif
                            <div id="_thursday" class="timeSlots">
                            </div>
                            <a href="javascript:void(0)" onclick="add(this)" data-day="_thursday" class="btn btn-primary  mr-2"> <b><i class="icon-plus22"></i></b>Adicionar Horário</a>
                            <hr>
                            <div class="form-group row mb-0">
                                <div class="col-lg-12">
                                    <h4>Sexta-Feira</h4>
                            ...
                            <!-- Checks if there is any schedule data -->
                            @if(!empty($working_time->_friday) && count($working_time->_friday) > 0)
                            <!-- If yes Then Loop Each Data as Time SLots -->
                            @foreach($working_time->_friday as $time)
                            <div class="form-group row">
                                <div class="col-lg-5">
                                    <label class="col-form-label">{{ __('storeDashboard.seOpeningTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->open}}"
                                        name="_friday[]" required>
                                </div>
                                <div class="col-lg-5">
                                    <label class="col-form-label"></span>{{ __('storeDashboard.seClosingTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->close}}"
                                ...
                                <div class="col-lg-2" day="_friday">
                                    <label class="col-form-label text-center" style="width: 70px;"></span>Remover</label><br>
                                    <button class='remove btn btn-danger btn-default btn-squared mr-15' style='padding: 10px;' data-popup='tooltip' data-placement='right' title='Remover Horário'><i class='la la-trash-alt'></i>
                                    </button>
                                </div>
                            ...
                            @endforeach
                            @endif 
                            <div id="_friday" class="timeSlots">
                            </div>
                            <a href="javascript:void(0)" onclick="add(this)" data-day="_friday" class="btn btn-primary mr-2"> <b><i class="icon-plus22"></i></b>Adicionar Horário</a>
                            <hr>
                            <div class="form-group row mb-0">
                                <div class="col-lg-12">
                                    <h4>Sábado</h4>
                            ...
                            <!-- Checks if there is any schedule data -->
                            @if(!empty($working_time->_saturday) && count($working_time->_saturday) > 0)
                            <!-- If yes Then Loop Each Data as Time SLots -->
                            @foreach($working_time->_saturday as $time)
                            <div class="form-group row">
                                <div class="col-lg-5">
                                    <label class="col-form-label">{{ __('storeDashboard.seOpeningTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->open}}"
                                        name="_saturday[]" required>
                                </div>
                                <div class="col-lg-5">
                                    <label class="col-form-label"></span>{{ __('storeDashboard.seClosingTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->close}}"
                                ...
                                <div class="col-lg-2" day="_saturday">
                                    <label class="col-form-label text-center" style="width: 70px;"></span>Remover</label><br>
                                    <button class='remove btn btn-danger btn-default btn-squared mr-15' style='padding: 10px;' data-popup='tooltip' data-placement='right' title='Remover Horário'><i class='la la-trash-alt'></i>
                                    </button>
                                </div>
                            ...
                            @endforeach
                            @endif
                            <div id="_saturday" class="timeSlots">
                            </div>
                            <a href="javascript:void(0)" onclick="add(this)" data-day="_saturday" class="btn btn-primary  mr-2"> <b><i class="icon-plus22"></i></b>Adicionar Horário</a>
                            <hr>
                            <div class="form-group row mb-0">
                                <div class="col-lg-12">
                                    <h4>Domingo</h4>
                            ...
                            <!-- Checks if there is any schedule data -->
                            @if(!empty($working_time->_sunday) && count($working_time->_sunday) > 0)
                            <!-- If yes Then Loop Each Data as Time SLots -->
                            @foreach($working_time->_sunday as $time)
                            <div class="form-group row">
                                <div class="col-lg-5">
                                    <label class="col-form-label">{{ __('storeDashboard.seOpeningTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->open}}"
                                        name="_sunday[]" required>
                                </div>
                                <div class="col-lg-5">
                                    <label class="col-form-label"></span>{{ __('storeDashboard.seClosingTime') }}</label>
                                    <input type="text" class="form-control clock" value="{{$time->close}}"
                                ...
                                <div class="col-lg-2" day="_sunday">
                                    <label class="col-form-label text-center" style="width: 70px;"></span>Remover</label><br>
                            ...
                            @endforeach
                            @endif
                            <div id="_sunday" class="timeSlots">
                            </div>
                            <a href="javascript:void(0)" onclick="add(this)" data-day="_sunday" class="btn btn-primary  mr-2"> <b><i class="icon-plus22"></i></b>Adicionar Horário</a>
                            <hr>
