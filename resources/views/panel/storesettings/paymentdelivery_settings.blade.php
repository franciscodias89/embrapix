        ...
        <div class="card">
            <div class="card-header  px-sm-25 px-3">
                <div class="edit-profile__title">
                    <h6>Configurações de Pagamento (Entrega)</h6>
                        ...
                        <div class="edit-profile__body mx-lg-20">
                           ...
                           <div class="atbd-nav-controller">
                              <div class="btn-group atbd-button-group btn-group-normal nav" role="tablist">
                                  ...
                                  <a href="{{ route('panel.PaymentDeliverySettings') }}" class="btn btn-sm btn-outline-light nav-link active" id="size-default"  aria-controls="default" aria-selected="true"> Pagamento na Entrega</a>
                                  @endif
                           ...
                           <form 
                           action="{{ route('settings.savePaymentDeliverySettings') }}" 
                           method="POST" 
                           ...
                           <input hidden type="text" value="paymentdelivery" class="form-control" name="tipo">
                              ...
                              <div class="notification-content p-25 border mb-25 mt-25">
                                 <div class="notification-content__title d-flex justify-content-between flex-wrap pb-20 text-capitalize">
                                    <h6 class="fs-15 text-light fw-500 lh-normal">Pagamento na Entrega</h6>
                                    ...
                                    <div class="notification-content__body p-25 border-bottom">
                                       <div class="d-flex justify-content-between flex-wrap align-items-center">
                                          <div class="div col-lg-10 col-sm-10">
                                             <h6>Habilitar Pagamento na Entrega</h6> <br><small></small>
                                             <span>Ao habilitar o pagamento pelo app, os usuários poderão pagar diretamente para o Entregador, em dinheiro ou cartão (usando a maquinhinha da loja). Não será cobrada nenhuma taxa. </span>
                                          </div>
                                 ...
                                 <div class="global-shadow radius-xl bg-white" id="pagamento_entrega">
                                    <div class="notification-content__body p-25 border-bottom">
                                       <div class="d-flex justify-content-between flex-wrap align-items-center">
                                          ...
                                          <div class="custom-control custom-switch my-lg-0 my-10 col-lg-2 col-sm-2" style="float: right">
                                             <input type="checkbox" class="custom-control-input"  name="delivery_payment_type_money" id="nc4" @if($delivery_payment_type['delivery_payment_type_money']==1) checked="checked" @endif >
                                          ...
                                          <div class="custom-control custom-switch my-lg-0 my-10 col-lg-2 col-sm-2" style="float: right">
                                             <input type="checkbox" class="custom-control-input"  name="delivery_payment_type_credit_card" id="nc5" @if($delivery_payment_type['delivery_payment_type_credit_card']==1) checked="checked" @endif >
                                          ...
                                          <div class="custom-control custom-switch my-lg-0 my-10 col-lg-2 col-sm-2" style="float: right">
                                             <input type="checkbox" class="custom-control-input"  name="delivery_payment_type_debit_card" id="nc6" @if($delivery_payment_type['delivery_payment_type_debit_card']==1) checked="checked" @endif >
                                          ...
                                          <div class="custom-control custom-switch my-lg-0 my-10 col-lg-2 col-sm-2" style="float: right">
                                             <input type="checkbox" class="custom-control-input"  name="delivery_payment_type_pix" id="nc7" @if($delivery_payment_type['delivery_payment_type_pix']==1) checked="checked" @endif >
...
var payment_delivery_accept= "<?php  echo $restaurant->payment_delivery_accept; ?>";  
