      ...
      <div class="card">
          <div class="card-header  px-sm-25 px-3">
              <div class="edit-profile__title">
                  <h6> Configurações de Delivery</h6>
                  <span class="fs-13 color-light fw-400">Configure abaixo o tempo de entrega e a taxa de entrega para cada faixa de distância.</span>
              </div>
                      ...
                      <div class="edit-profile__body mx-lg-20">
                        ...
                        <div class="atbd-nav-controller">
                            <div class="btn-group atbd-button-group btn-group-normal nav" role="tablist">
                               ...
                               <a href="{{ route('panel.DeliveryTime') }}" class="btn btn-sm btn-outline-light nav-link active" id="size-default"  aria-controls="default" aria-selected="true"> Tempo de Entrega</a>
                        ...
                        <form 
                                       action="{{ route('settings.saveDeliveryTime') }}" 
                                       method="POST" 
                                       ...
                                       {{--          <span>ATENÇÃO!! Apareça em uma lista especial e ganhe destaque no Compra Bakana com entrega grátis até 1 km.</span> --}}
                                                ...
                                                <div class="d-flex justify-content-between flex-wrap align-items-center">
                                                   <div class="div col-lg-10 col-sm-10">
                                                    <label><strong>Habilitar Entrega Grátis para compras acima de R$</strong></label>
                                                    <br>
                                                ...
                                                <div class='form-group row'> 
                                                   ...
                                                   <div class='col-lg-2'>
                                                      ...
                                                      @endif
                                                    <input type='text' class='form-control form-control-lg' hidden  value="{{ $list_distance[$loop->index]['km'] }}" name="time_km[{{$loop->index}}][km]" placeholder="Km"> 
                                                   </div>  
                                                   <div  class='col-lg-2'> 
                                                    <input type='text' class='form-control  form-control-lg dinheiro' value="{{ $list_distance[$loop->index]['price'] }}" name="time_km[{{$loop->index}}][price]" placeholder="Preço"> 
                                                   </div>  
                                                   <div  class='col-lg-3 price_free_shipping'> 
                                                      <input type='text' class='form-control  form-control-lg dinheiro' @if(isset($list_distance[$loop->index]['price_free_shipping'])) value="{{  $list_distance[$loop->index]['price_free_shipping']  }}" @endif name="time_km[{{$loop->index}}][price_free_shipping]" placeholder="Valor"> 
                                                     </div> 
                                                   <div  class='col-lg-2'> 
                                                         <input type='number' class='form-control  form-control-lg' value="{{ $list_distance[$loop->index]['time'] }}" name="time_km[{{$loop->index}}][time]" placeholder="Tempo"> 
                                                   </div> 
                                                   <div  class='col-lg-3'>
