      ...
      <div class="card">
          <div class="card-header px-sm-25 px-3">
              <div class="edit-profile__title">
                  ...
                  <span class="fs-13 color-light fw-400">As informações abaixo ficarão disponíveis publicamente na página de Informações do seu Negócio dentro do Aplicativo.</span>
              </div>
              ...
              <div class="row justify-content-center">
                  <div class="col-xl-8 col-lg-10 col-sm-10">
                      <div class="edit-profile__body mx-lg-20">
                          <form action="{{ route('settings.saveProfile') }}" method="POST" 
                          id="profile_form" 
                          ...
                          enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-40 mb-40">
                                <div class="cityOption">
                                    <label for="store_category">Tipo de Negócio:</label>
                                    <p><small>*Essa é uma escolha importante que impactará na forma como sua loja vende no aplicativo. Se seu negócio for do tipo: Restaurantes, Bares, Hamburguerias, Pizzarias, Marmitex, Bebidas de consumo rápido, ou quaisquer nichos de "Comida", marque a opção: "Comida e Bebidas de Consumo Imediato" </small></p>
                          
                                      <select  class="js-example-basic-single js-states form-control" id="select-business_type"  required parsley-trigger="change" data-parsley-errors-container="#select22"  data-parsley-group="form-step-1" name="business_type" data-parsley-required>
                                         
                                         <option value="1" class="text-capitalize" <?php if ($restaurant->business_type ==1) { echo "selected"; } ?> > Comida e Bebidas de Consumo Imediato</option>
                                         <option value="2" class="text-capitalize" <?php if ($restaurant->business_type ==2) { echo "selected"; } ?> > Produtos Diversos</option>
                                      </select>
                                </div>
                            </div>
                            <div class="form-group mt-40 mb-40">
                                <div class="cityOption">
                                    <label for="store_category">Localização/Região:</label>
                                   
                                      <select  class="js-example-basic-single js-states form-control" id="select-location"  required parsley-trigger="change" data-parsley-errors-container="#select55"  data-parsley-group="form-step-1" name="location_id" data-parsley-required>
                                        @foreach($restaurantLocations as $rC)
                                        <option value="{{ $rC->id }}" class="text-capitalize" <?php if ($restaurant->location_id==$rC->id ) { echo "selected"; } ?> >{{ $rC->name }}</option>
                                        @endforeach
                            ...
                            <div class="form-group mb-20">
                                <label for="contact_manager">Nome do Responsável pelo Cadastro da Loja</label>
                                  <input required type="text" value="{{ $restaurant->contact_manager }}" class="form-control" name="contact_manager"
                                  id="contact_manager" placeholder="">
                            </div>
                            <div class="form-group mb-20">
                                <label for="contact_manager_whatsapp">Whatsapp do Responsável pelo Cadastro da Loja</label>
                                <p><small>*Para contatos, dúvidas e suporte técnico com relação ao cadastro da loja, produtos, etc. </small></p>
                          
                                
                                  <input required type="text" value="{{ $restaurant->contact_manager_whatsapp }}" class="form-control phone" name="contact_manager_whatsapp"
                                  id="contact_manager_whatsapp" placeholder=""> 
                            </div>    
                                  
                            
          
                               <div class="form-group mb-40 mt-40">
                                   ...
                                   <p><small>Coloque aqui uma pequena descrição do seu negócio. Esse texto aparecerá na página de Informações sobre sua Loja, no aplicativo. </small></p>
                            ...
                            <div class="row">
                               ...
                               <div class="form-group  col-md-6" style="float: right;">
                                   <label for="telefone">Telefone da Loja</label> <small> (opcional)</small>
                                   <input type="text" value="{{ $restaurant->telefone }}" class="form-control phone" name="telefone"
                                       id="telefone">
                                       <div class="help-block with-errors"></div>
                               </div>
                               <div class="form-group  col-md-6" style="float: right;">
                                   <label for="whatsapp">Whatsapp da Loja</label> <small> (opcional)</small>
