            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Cupons de Desconto</h4>
                    ...
                    <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                             ...
                             <div class="project-category d-flex align-items-center  mt-xl-10 mt-15">
                                ...
                                <div class="project-tap order-project-tap global-shadow">
                                    <ul class="nav px-1" id="ap-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('panel.coupons') ? 'active' : ''}}" href="{{ route('panel.coupons') }}">Todos</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('panel.couponsDeleted') ? 'active' : ''}}" href="{{ route('panel.couponsDeleted') }}">Lixeira</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="content-center mt-10">
                            <div class="button-group m-0 mt-xl-0 mt-sm-10 order-button-group">
                                ...
                                <i class="la la-plus"></i>Adicionar Cupom</button>
                                        ...
                                        @foreach ($coupons as $coupon)
                                            <tr class="item">
                                                ...
                                                <td style="white-space:normal;">
                                                    <div class="orderDatatable-title">{{ $coupon->description }}
                                                    </div>
                                                </td>
                                                <td>
                                                    @if($coupon->discount_type == "PERCENTAGE")
                                                    <div class="orderDatatable-status d-inline-block">
                                                        <span class="order-bg-opacity-success  text-success rounded-pill active">{{ $coupon->discount }}% de desconto</span>
                                                    </div>
                                                    
                                                    @endif
                                                    @if($coupon->discount_type == "AMOUNT")
                                                    <div class="orderDatatable-status d-inline-block">
                                                        <span class="order-bg-opacity-primary  text-primary rounded-pill active">R$ {{ $coupon->discount }} de desconto</span>
                                                    </div>
                                                    @endif
                                                </td>
                                                <td><div class="orderDatatable-title">
                                                    Max:{{ $coupon->max_count }}
                                                <br>Uso:{{ $coupon->count }} </div></td>
                                                @if(Request::is('store-owner/coupons/deleted'))
                                                @else
                                                <td>
                                                ...
                                                <td><div class="orderDatatable-title">{{ $coupon->created_at->diffForHumans() }}</div></td>
                                                <td>
                                                    @if($coupon->expiry_date < now())
                                                  
                                                    <div class="orderDatatable-status d-inline-block" >
                                                       <span class="order-bg-opacity-danger  text-danger rounded-pill active"  style="height:32px" >Vencido em: <br>{{ date('d/m/Y', strtotime($coupon->expiry_date))  }} </span>
                                                   </div>
                                                   
                                                   @else
                                                   <div class="orderDatatable-title">{{ date('d/m/Y', strtotime($coupon->expiry_date))  }}
                                                    </div>
                                                   @endif
                                                ...
                                                <td class="text-center">
                                                    <ul class="orderDatatable_actions mb-0 d-flex flex-wrap float-right">
                                                        ...
                                                        @if(Request::is('store-owner/coupons/deleted'))
                                                        <li>
                                                            <a href="{{ route('panel.restoreCoupon', $coupon->id) }}" title="Restaurar" class="edit">
                                                                <span data-feather="rotate-ccw" ></span></a>
                                                        </li>
                                                        @else
                                                        <li>
                                                            <a href="{{ route('panel.get.getEditCoupon', $coupon->id) }}" title="Editar" class="edit">
                                                                <span data-feather="edit"></span></a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('panel.deleteCoupon', $coupon->id) }}" title="Excluir" onclick="return confirm('Tem certeza de que deseja excluir este item?')" class="remove">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Adicionar Cupom de Desconto</span></h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form action="{{ route('panel.post.saveNewCoupon') }}" method="POST" enctype="multipart/form-data" data-parsley-trigger="keyup" data-parsley-validate>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pl30 pr30">
                                        ...
                                        <div class="inline-block">
                                            ...
                                            <div class="form-group col-md-6 hidden" style="padding-left: 0px;" id="value_percentage">
                                        ...
                                        <div class="form-group row hidden" id="maxUsePerUser">
                                            <label >Número máximo de vezes por cliente: </label>
                                                ...
                                                <input type="number" class="form-control form-control-lg max_count_per_user" name="max_count_per_user"
                                                    placeholder="Número máximo de vezes por cliente">
