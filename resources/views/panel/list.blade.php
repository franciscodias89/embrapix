                        ...
                        <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                 ...
                                 <div class="project-category d-flex align-items-center  mt-xl-10 mt-15">
                                    ...
                                    <div class="project-tap order-project-tap global-shadow">
                                        <ul class="nav px-1" id="ap-tab" role="tablist">
                                            @if($route_all)
                                            <li class="nav-item">
                                                <a class="nav-link {{ Route::is($route_all) ? 'active' : ''}}" href="{{ route($route_all) }}">Todos</a>
                                            </li>
                                            @endif
                                            @if($route_deleted)
                                           
                                            <li class="nav-item">
                                                <a class="nav-link {{ Route::is($route_deleted) ? 'active' : ''}}" href="{{ route($route_deleted) }}">Lixeira</a>
                                            </li>
                                            @endif
                                        </ul>
                                    </div>
                            ...
                            <div class="content-center mt-10">
                                <div class="button-group m-0 mt-xl-0 mt-sm-10 order-button-group">
                                    ...
                                    data-toggle="modal" data-target="{{ $add_target }}">
                                    <i class="la la-plus"></i>{{ $add_button_title }}</button>
                                    @endif
