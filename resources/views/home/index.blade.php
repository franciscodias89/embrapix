...
<div id="msgInstallWCPP" style="display:none;">
    ...
    <p>
        <a href="{{action('Panel\HomeController@printESCPOS')}}" >You can go and test the printing page...</a>
    </p>
...
<script type="text/javascript">
            ...
            var wcppPingTimeout_ms = 3000; //60 sec
            ...
            function wcppDetectOnSuccess(){
                ...
                if(wcppVer.substring(0, 1) == "6")
                   alert('tem');
                   // window.location.href = '{{action('Panel\HomeController@printESCPOS')}}';
