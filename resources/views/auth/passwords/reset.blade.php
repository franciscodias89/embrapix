                                    ...
                                    <div class="card border-0">
                                        <div class="card-header border-0  pb-md-15 pb-10 pt-md-20 pt-10 ">
                                            <div class="edit-profile__title">
                                                <h6>{{ __('Criar Nova') }} <span class="color-primary">Senha</span></h6>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="edit-profile__body">
                                                <form method="POST"  method="POST" action="{{ route('password.update') }}">
                                                    ...
                                                    <div class="form-group mb-15">
                                                        <label for="password-field">Crie uma Nova Senha</label>
                                                    ...
                                                    <div class="form-group mb-15">
                                                        <label for="password-field">Confirmar Senha</label>
                                                        <div class="position-relative">
