                  ...
                  <div class="col-xl-7 col-lg-8 col-sm-10">
                     <div class="card checkout-shipping-form px-30 pt-2 pb-30 border-color">
                        <div class="card-header border-bottom-0 align-content-start pb-sm-0 pb-1 px-0">
                           <h4 class="fw-500">5. Horários de Delivery/Retirada</h4>
                            </div>
                        ...
                        <div class="card-body px-0 pb-0">
                           ...
                           <div class="atbd-nav-controller">
                              <div class="btn-group atbd-button-group btn-group-normal nav" role="tablist">
                                  <a href="{{ route('wizard.wizard_5') }}" class="btn btn-sm btn-outline-light nav-link " id="size-tipo_entrega" data-toggle="tab" role="tab" aria-controls="tipo_entrega" aria-selected="true">Horários de Delivery</a>
                                  <a href="{{ route('wizard.wizard_5_1') }}" class="btn btn-sm btn-outline-light nav-link active" id="size-default" data-toggle="tab" role="tab" aria-controls="default" aria-selected="false"> Horários para Retirada</a>
                                   </div>
                           </div>
                                       ...
                                       <div class="edit-profile__body">
                                          <form 
                                       action="{{ route('wizard.savewizard_5_1') }}" 
                                       method="POST" 
