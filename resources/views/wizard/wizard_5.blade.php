                        ...
                        <div class="card-body px-0 pb-0">
                           ...
                           <div class="atbd-nav-controller">
                              <div class="btn-group atbd-button-group btn-group-normal nav" role="tablist">
                                  <a href="{{ route('wizard.wizard_5') }}" class="btn btn-sm btn-outline-light nav-link active" id="size-tipo_entrega" data-toggle="tab" role="tab" aria-controls="tipo_entrega" aria-selected="true">Horários de Delivery</a>
                                  @if(($restaurant->delivery_type == 2 )|| ($restaurant->delivery_type == 3))
                                  <a href="{{ route('wizard.wizard_5_1') }}" class="btn btn-sm btn-outline-light nav-link" id="size-default" data-toggle="tab" role="tab" aria-controls="default" aria-selected="false"> Horários para Retirada</a>
                                  @endif
                                </div>
                           </div>
                                       ...
                                       <div class="edit-profile__body">
                                          <form 
                                       action="{{ route('wizard.savewizard_5') }}" 
                                       method="POST" 
