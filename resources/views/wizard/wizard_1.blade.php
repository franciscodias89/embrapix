                                    ...
                                    <div class="cityOption">
                                        ...
                                        <p><small>*Essa é uma escolha importante que impactará na forma como sua loja vende no aplicativo. Se seu negócio for do tipo: Restaurantes, Bares, Hamburguerias, Pizzarias, Marmitex, Bebidas de consumo rápido, ou quaisquer nichos de "Comida", marque a opção: "Comida e Bebidas de Consumo Imediato" </small></p>
                                          ...
                                          <select  class="js-example-basic-single js-states form-control" id="select-business_type"  required parsley-trigger="change" data-parsley-errors-container="#select22"  data-parsley-group="form-step-1" name="business_type" data-parsley-required>
                                             ...
                                             <option value="comida" class="text-capitalize" <?php if ($restaurant->business_type ='comida') { echo "selected"; } ?> > Comida e Bebidas de Consumo Imediato</option>
                                             <option value="outros" class="text-capitalize" <?php if ($restaurant->business_type ='outros') { echo "selected"; } ?> > Produtos Diversos</option>
                                          </select>
                                    </div>
                                </div>
