                           ...
                           <div class="edit-profile__body">
                              <form action="{{ route('wizard.savewizard_1') }}" method="POST"  enctype="multipart/form-data">
                                 ...
                                 <div class="d-flex pt-15 justify-content-md-end justify-content-center">
                                    <a href="{{ route('wizard.wizard_1') }}" class="btn text-white btn-danger btn-default btn-squared text-capitalize m-1">Começar<i class="ml-10 mr-0 las la-arrow-right"></i></a>
                                 </div>
