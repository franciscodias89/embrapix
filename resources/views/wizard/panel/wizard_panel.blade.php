                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-main">
                            <h4 class="breadcrumb-title">  Olá, Falta Pouco para ter sua Loja Publicada no Aplicativo!</h4>
                        ...
                        <span>Siga as orientações abaixo para deixar sua loja pronta para começar a vender!</span><br><br>
                    </div>
                            ...
                            <div class="card-body text-center p-0">
                                ...
                                <div class="ps-tab p-20 pb-25">
                                    <div class="nav flex-column text-left" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <a class="nav-link active" id="v-pills-panel1-tab" data-toggle="pill" href="#v-panel1_gerais" role="tab" aria-controls="v-pills-panel1" aria-selected="true">
                                            @if($categories_check)
                                                <span class="badge badge-success menuItem mr-15"><i class="fas fa-check"></i></span>Categorias
                                            @else
                                                <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>Categorias
                                            @endif
                                        </a>
                                        <a class="nav-link" id="v-pills-panel2-tab" data-toggle="pill" href="#v-pills-panel2" role="tab" aria-controls="v-pills-panel2" aria-selected="false">
                                            @if($addons_check)
                                            <span class="badge badge-success menuItem mr-15"><i class="fas fa-check"></i></span>Opcionais
                                        @else
                                            <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>Opcionais
                                        @endif

                                    </a>  
                                        <a class="nav-link" id="v-pills-panel3-tab" data-toggle="pill" href="#v-pills-panel3" role="tab" aria-controls="v-pills-panel3" aria-selected="false">
                                           
                                            @if($items_check)
                                            <span class="badge badge-success menuItem mr-15"><i class="fas fa-check"></i></span>Produtos
                                        @else
                                            <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>Produtos
                                        @endif
                                    </a>    
                                        <a class="nav-link" id="v-pills-panel4-tab" data-toggle="pill" href="#v-pills-panel4" role="tab" aria-controls="v-pills-panel4" aria-selected="false">
                                            
                                            @if($flyers_check)
                                            <span class="badge badge-success menuItem mr-15"><i class="fas fa-check"></i></span>Folhetos
                                        @else
                                            <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>Folhetos
                                        @endif
                                            
                                    </a>
                                        
                                        <a class="nav-link" id="v-pills-panel5-tab" data-toggle="pill" href="#v-pills-panel5" role="tab" aria-controls="v-pills-panel5" aria-selected="false">
                                            @if($coupons_check)
                                            <span class="badge badge-success menuItem mr-15"><i class="fas fa-check"></i></span>Cupons de Desconto
                                        @else
                                            <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>Cupons de Desconto
                                        @endif   
                                    </a>   
                                        <a class="nav-link" id="v-pills-panel6-tab" data-toggle="pill" href="#v-pills-panel6" role="tab" aria-controls="v-pills-panel6" aria-selected="false">
                                            @if($restaurant->cashback_active)
                                            <span class="badge badge-success menuItem mr-15"><i class="fas fa-check"></i></span>CashBack
                                        @else
                                            <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>CashBack
                                        @endif 
                                            
                                    </a>   
                                            <a class="nav-link" id="v-pills-panel7-tab" data-toggle="pill" href="#v-pills-panel7" role="tab" aria-controls="v-pills-panel7" aria-selected="false">
                                          @if($sorteios_check)
                                            <span class="badge badge-success menuItem mr-15"><i class="fas fa-check"></i></span>Sorteios
                                        @else
                                            <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>Sorteios
                                        @endif 
                                    </a> 
                                    
                                    <a class="nav-link" id="v-pills-panel8-tab" data-toggle="pill" href="#v-pills-panel8" role="tab" aria-controls="v-pills-panel8" aria-selected="false">
                                        @if($printer_name)
                                        <span class="badge badge-success menuItem mr-15"><i class="fas fa-check"></i></span>Configurar Impressora
                                    @else
                                        <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>Configurar Impressora
                                    @endif 
                                        
                                </a> 
                                <a class="nav-link" id="v-pills-panel9-tab" data-toggle="pill" href="#v-pills-panel9" role="tab" aria-controls="v-pills-panel9" aria-selected="false">
                                    @if($user_tester)
                                    <span class="badge badge-success menuItem mr-15"><i class="fas fa-check"></i></span>Testar Loja no APP
                                @else
                                    <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>Testar Loja no APP
                                @endif 
                                    
                            </a> 

                            <a class="nav-link" id="v-pills-panelPublicar-tab" data-toggle="pill" href="#v-pills-panelPublicar" role="tab" aria-controls="v-pills-panelPublicar" aria-selected="false">
                                
                                <span class="badge badge-danger menuItem mr-15"><i class="fas fa-exclamation mr-1 ml-1"></i></span>Publicar Loja no APP
                    ...
                    @endif
                        <div class="">
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                @include('wizard.panel.wizard_panel1')

                                @include('wizard.panel.wizard_panel2')
                                @include('wizard.panel.wizard_panel3')
                                @include('wizard.panel.wizard_panel4')
                                @include('wizard.panel.wizard_panel5')
                                @include('wizard.panel.wizard_panel6')
                                @include('wizard.panel.wizard_panel7')
                                @include('wizard.panel.wizard_panel8')
                                @include('wizard.panel.wizard_panel9')
                                @include('wizard.panel.wizard_panelPublicar')
                            </div>
                        </div>
                    </div>
                </div>
