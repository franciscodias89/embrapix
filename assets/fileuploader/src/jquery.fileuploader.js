...
;(function(factory) {
    ...
    $.fn.fileuploader.languages = {
        ...
        en: {
            button: function(options) {
                return 'Procurar ' + (options.limit == 1 ? 'file' : 'arquivos')
            },
            feedback: function(options) {
                return 'Procurar ' + (options.limit == 1 ? 'file' : 'arquivos') + ' para fazer upload'
            },
            feedback2: function(options) {
                return options.length + ' ' + (options.length > 1 ? ' files were' : ' file was') + ' escolhidos'
            },
            confirm: 'Confirmar',
            cancel: 'Cancelar',
            name: 'Nome',
            ...
            download: 'Download',
            remove: 'Apagar',
            drop: 'Arraste e solte imagens aqui para fazer upload',
            paste: '<div class="fileuploader-pending-loader"></div> Pasting a file, click here to cancel',
            removeConfirmation: 'Tem certeza de que deseja deletar este arquivo??',
            errors: {
                filesLimit: function(options) {
                    return 'Você pode fazer upload de somente ${limit} ' + (options.limit == 1 ? 'file' : 'arquivos') 
                },
                filesType: 'Somente arquivos ${extensions} são permitidos',
                fileSize: '${name} é muito grande! Por favor, escolha um arquivo com no máximo ${fileMaxSize} MB.',
                filesSizeAll: 'Os arquivos selecionados são muito grandes! Favor selecionar arquivos com no máximo ${maxSize} MB.',
